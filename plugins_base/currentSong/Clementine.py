...
#   
#    CurrentSong plugin extension for Clementine
#    Gustavo M. Brunoro <gustavo.brunoro@gmail.com>
#    
#    Based on CurrentSong plugin extension for Amarok2 by
...
class Clementine( CurrentSong.DbusBase ):
    '''Clementine CurrentSong Plugin.'''
